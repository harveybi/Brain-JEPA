...
#SBATCH --output=/p/project1/hai_1148/results/logs/SEEDV/%j.out
#SBATCH --error=/p/project1/hai_1148/results/logs/SEEDV/%j.err
...
LOG_ROOT="/p/project1/hai_1148/results/logs/SEEDV"
