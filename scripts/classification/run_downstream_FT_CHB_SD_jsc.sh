...
#SBATCH --output=/p/project1/hai_1148/results/logs/CHB/%j.out
#SBATCH --error=/p/project1/hai_1148/results/logs/CHB/%j.err
...
LOG_ROOT="/p/project1/hai_1148/results/logs/CHB"
