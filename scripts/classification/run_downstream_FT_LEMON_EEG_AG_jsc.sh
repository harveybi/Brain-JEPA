...
#SBATCH --output=/p/project1/hai_1148/results/logs/LEMON_EEG/%j.out
#SBATCH --error=/p/project1/hai_1148/results/logs/LEMON_EEG/%j.err
...
LOG_ROOT="/p/project1/hai_1148/results/logs/LEMON_EEG"
